...
/* function renderDungeonItemsMenuTabs(core: ITPCore, ImGui: IImGui){
...
function renderQuestItemsMenuTabs(core: ITPCore, ImGui: IImGui){
...
function renderItemsMenuTabs(core: ITPCore, ImGui: IImGui){
...
function renderCheatMenuTabs(core: ITPCore, ImGui: IImGui){
...
export function renderModWindow(core: ITPCore, ImGui: IImGui){
    if(modWindows.link[0]){
...
/* export function renderPosWindow(core: ITPCore, ImGui: IImGui){
    if(openPosWindow[0]){
